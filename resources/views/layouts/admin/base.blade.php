...
<head>
    ...
    <title>{{ config('app.name', 'Natela') }}</title>
        ...
        <div class="sidebar-wrapper">
            <div class="logo">
                <a href="{{ route('admin.dashboard') }}" class="simple-text">
                    <img src="{{ asset('img/logo-natela.png') }}">
                </a>
            </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="http://www.natelaweb.com.br" target="_blank">Natela Soluções Web</a>
                </div>
            </div>
        </footer>
